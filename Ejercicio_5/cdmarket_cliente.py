...
juego1 = Videojuego("The Last of Us", Genero.Accion_aventuras.value, [Plataforma("PS4", False), Plataforma("PC", False)], "Historia postapocaliptica con un mundo de infectados", 5999.9, emp_desa1, emp_dis1, date(2014, 7, 29), 19.7)
